...
Training a Deep Learning Neural Network model to classify 7 anime charaters in Onepiece. 
...
4. Configure and preprocessthe dataset 
5. Build the VGG-16 model
6. Train the model by 20 epoches
7. Plot the training and validation loss to evaluate the performance
